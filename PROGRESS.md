...
- [x] M6 Dashboard: accuracy, answered, streak, unseen tiles. Area heatmap (diverging around 70%, tap to drill into PIs with attempt counts). Weakest 5 PIs with a Practice-these button. Mock score trend with hover tooltip and a table view
- [ ] M7 Polish
